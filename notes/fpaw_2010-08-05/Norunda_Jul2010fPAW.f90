...
real :: ASW_FC     ! ASW at field capacity
...
!parameters for fASW function
real, parameter :: ASW_max = 50   ! ASW for max g - percentage
real, parameter :: ASW_min = 0    ! ASW for min g - percentage
...
Gsto_1 = gmax * fphen * leaf_flight * max(fmin, ftemp * fVPD * fSWP)   
...
fswp = (1-fmin) / (ASW_min - ASW_max) * (ASW_min - ((ASW/ASW_FC)*100)) + fmin
fsWP = max(fswp, fmin)
...
write (unit=8, fmt=*) mm, mdd, dd, hr, Ra_O3, Rb, Rsto, Uzh, LAI, SAI, Fphen, &
                      ...
                      SMD, SWP, fswp, Gsto_c, Rsur, Vd, &
                      Fst, AFstY, gO3, uh, &
                      O3_ppb, PET_use, AET_use, &
		      Rsto_PEt, Ei_use, LAI, ustar, Ra_O3, Sn, &
                      Ftot, Ra_u, Per_vol, ASW, Sn_diff, LWP, LWP_1, deltaLWP, fLWP, &
                      Et_hr_1, delta_Et, delta_t, SWP_1, sn_diff_layers, Et_hr,  &


                      Sn_D1, Sn_D2, Sn_D3, Sn_D4, &
                      SWP_D1, SWP_D2, SWP_D3, SWP_D4, fSWP_D1, fSWP_D2, fSWP_D3, fSWP_D4, &
                      r_D1, r_D2, r_D3, r_D4, &
                      ...
                      Rsr_D3, Rsr_D4, Gsto, Sn_meas, SWP_meas, &
            P_input, Sn, SWP, ASW, fSWP, Sn_meas, SWP_meas, LWP, fLWP, AEt_use, AEt_hr, Gsto_c, Gsto, AFstY, RbH2O, fVPD, &
            Ra_o3, Rsto, rsr, SMD 
