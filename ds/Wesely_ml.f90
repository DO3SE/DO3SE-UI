...
!---------------------------------------
! Derived values are generated from Weseley data with test prog which follows:

!/ Ratio of diffusivites compared to ozone..

real, public, dimension(NWESELY), save ::   &     ! Ratio D(O3)/D(x)
 DRx = (/ &     
   0.842105  , &
   1.00000  , &
   1.00000  , &
...
real, public, dimension(NWESELY), save :: &  
  Rb_cor = (/ &
   1.37119  , &
   1.22276  , &
   1.22276  , &
