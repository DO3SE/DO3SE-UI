...
output_fields = dicts_to_map(to_dicts(('module', 'variable', 'type', 'short', 'long'), (
        ...
        (variables,     'afst0',    float,  'POD0 (nmol/m^2/s)',u'Accumulated Fst (POD0, nmol/m\u00b2/s)'),
        (variables,     'afsty',    float,  'PODY (nmol/m^2/s)',u'Accumulated Fst over threshold Y (PODY, nmol/m\u00b2/s)'),
...
paramdefs = dicts_to_map(to_dicts(('group', 'variable', 'cls', 'args', 'name', 'contexthelp'), (
    ...
    ('vegchar', 'gmorph', FloatSpinField, (0.01, 1, 1, 0.01, 2), 'Sun/shade factor', ''),
    ...
    ('vegchar', 'y', FloatSpinField, (0.1, 100, 1.6, 0.1, 1), u'Threshold Y for AFstY (nmol/m\u00b2/s)', ''),
