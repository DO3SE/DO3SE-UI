...
input_fields = dicts_to_map(to_dicts(('module', 'variable', 'type', 'required', 'short', 'long'), (
        ...
        (inputs,    'co2',      float,  False,  'CO2 (ppm)',    u'Ambient CO\u2082 concentration (CO\u2082, ppm)'),
...
output_fields = dicts_to_map(to_dicts(('module', 'variable', 'type', 'short', 'long'), (
        ...
        (inputs,        'co2',      float,  'CO2 (ppm)',        u'Ambient CO\u2082 concentration (CO\u2082, ppm)'),
...
paramdefs = dicts_to_map(to_dicts(('group', 'variable', 'cls', 'args', 'name', 'contexthelp'), (
    ...
    ('siteloc', 'co2_constant', disableable(FloatSpinField, 'Use input'), (0.0, 10000.0, 391.0, 1.0, 1),
        u'CO\u2082 concentration (ppm)', 'Overridden if CO2 is supplied by input data'),
