...
\fhref{http://sourceforge.net/project/mingw/files/}{MinGW download page}---click on ``Automated 
...
\fhref{http://sourceforge.net/project/mingw/files/}{MinGW download page}---click on ``MSYS Base 
