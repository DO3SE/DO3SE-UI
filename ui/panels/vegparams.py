...
class VegParams(wx.Panel):
    def __init__(self, *args, **kwargs):
        ...
        self.fieldgroup.add_field('h', Field(
                lambda : float(self.fields['h'].GetValue()),
                self.fields['h'].SetValue))
        ...
        self.fieldgroup.add_field('root', Field(
                lambda : float(self.fields['root'].GetValue()),
                self.fields['root'].SetValue))
        ...
        self.fieldgroup.add_field('lai_min', Field(
                lambda : float(self.fields['lai_min'].GetValue()),
                self.fields['lai_min'].SetValue))
        ...
        self.fieldgroup.add_field('lai_max', Field(
                lambda : float(self.fields['lai_max'].GetValue()),
                self.fields['lai_max'].SetValue))
        ...
        self.fieldgroup.add_field('lm', Field(
                lambda : float(self.fields['lm'].GetValue()),
                self.fields['lm'].SetValue))
        ...
        self.fieldgroup.add_field('albedo', Field(
                lambda : float(self.fields['albedo'].GetValue()),
                self.fields['albedo'].SetValue))
        ...
        self.fieldgroup.add_field('rext', Field(
                lambda : float(self.fields['rext'].GetValue()),
                self.fields['rext'].SetValue))
        ...
        self.fieldgroup.add_field('f_lightfac', Field(
                lambda : float(self.fields['f_lightfac'].GetValue()),
                self.fields['f_lightfac'].SetValue))
        ...
        self.fieldgroup.add_field('gmax', Field(
                lambda : float(self.fields['gmax'].GetValue()),
                self.fields['gmax'].SetValue))
        ...
        self.fieldgroup.add_field('fmin', Field(
                lambda : float(self.fields['fmin'].GetValue()),
                self.fields['fmin'].SetValue))
        ...
        self.fieldgroup.add_field('y', Field(
                lambda : float(self.fields['y'].GetValue()),
                self.fields['y'].SetValue))
        ...
        self.fieldgroup.add_field('sgs', Field(
                lambda : float(self.fields['sgs'].GetValue()),
                self.fields['sgs'].SetValue))
        ...
        self.fieldgroup.add_field('egs', Field(
                lambda : float(self.fields['egs'].GetValue()),
                self.fields['egs'].SetValue))
        ...
        self.fieldgroup.add_field('astart', Field(
                lambda : float(self.fields['astart'].GetValue()),
                self.fields['astart'].SetValue))
        ...
        self.fieldgroup.add_field('aend', Field(
                lambda : float(self.fields['aend'].GetValue()),
                self.fields['aend'].SetValue))
        ...
        self.fieldgroup.add_field('ls', Field(
                lambda : float(self.fields['ls'].GetValue()),
                self.fields['ls'].SetValue))
        ...
        self.fieldgroup.add_field('le', Field(
                lambda : float(self.fields['le'].GetValue()),
                self.fields['le'].SetValue))
        ...
        self.fieldgroup.add_field('t_min', Field(
                lambda : float(self.fields['t_min'].GetValue()),
                self.fields['t_min'].SetValue))
        ...
        self.fieldgroup.add_field('t_opt', Field(
                lambda : float(self.fields['t_opt'].GetValue()),
                self.fields['t_opt'].SetValue))
        ...
        self.fieldgroup.add_field('t_max', Field(
                lambda : float(self.fields['t_max'].GetValue()),
                self.fields['t_max'].SetValue))
        ...
        self.fieldgroup.add_field('vpd_min', Field(
                lambda : float(self.fields['vpd_min'].GetValue()),
                self.fields['vpd_min'].SetValue))
        ...
        self.fieldgroup.add_field('vpd_max', Field(
                lambda : float(self.fields['vpd_max'].GetValue()),
                self.fields['vpd_max'].SetValue))
        ...
        self.fieldgroup.add_field('swp_min', Field(
                lambda : float(self.fields['swp_min'].GetValue()),
                self.fields['swp_min'].SetValue))
        ...
        self.fieldgroup.add_field('swp_max', Field(
                lambda : float(self.fields['swp_max'].GetValue()),
                self.fields['swp_max'].SetValue))
        ...
        self.fieldgroup.add_field('fphen_a', Field(
                lambda : float(self.fields['fphen_a'].GetValue()),
                self.fields['fphen_a'].SetValue))
        ...
        self.fieldgroup.add_field('fphen_b', Field(
                lambda : float(self.fields['fphen_b'].GetValue()),
                self.fields['fphen_b'].SetValue))
        ...
        self.fieldgroup.add_field('fphen_c', Field(
                lambda : float(self.fields['fphen_c'].GetValue()),
                self.fields['fphen_c'].SetValue))
        ...
        self.fieldgroup.add_field('fphen_d', Field(
                lambda : float(self.fields['fphen_d'].GetValue()),
                self.fields['fphen_d'].SetValue))
        ...
        self.fieldgroup.add_field('fphens', Field(
                lambda : float(self.fields['fphens'].GetValue()),
                self.fields['fphens'].SetValue))
        ...
        self.fieldgroup.add_field('fphene', Field(
                lambda : float(self.fields['fphene'].GetValue()),
                self.fields['fphene'].SetValue))
